...
tokenizer_folder = '/users/kent/student/jmaharja/drugAbuse_ln/output/oct2022/TokRoBERTa'
tokenizer = RobertaTokenizerFast.from_pretrained(tokenizer_folder, max_len=MAX_LEN)

class TweetModel(RobertaPreTrainedModel):
    def __init__(self, conf, n_classes):
        super(TweetModel, self).__init__(conf)
        self.roberta = transformers.RobertaModel.from_pretrained('/users/kent/student/jmaharja/drugAbuse_ln/output/oct2022/RoBERTaMLM/', config=conf)
...
model.load_state_dict(torch.load('/users/kent/student/jmaharja/drugAbuse_ln/finetune/checkpoint/best_ftc_model_state2023_02_20-03_15PM.bin'))
